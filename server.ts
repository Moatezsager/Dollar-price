...
let appConfig: AppConfig = {
  ...
  terms: [
    ...
    { id: "GOLD_EXT_18", name: "ذهب خارجي 18", regex: "(?:ذهب خارجي\\s*18|خارجي\\s*18|عيار\\s*18\\s*خارجي|18\\s*خارجي)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 5000, isInverse: false, flag: "ly" },
    { id: "GOLD_EXT_21", name: "ذهب خارجي 21", regex: "(?:ذهب خارجي\\s*21|خارجي\\s*21|عيار\\s*21\\s*خارجي|21\\s*خارجي)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 5000, isInverse: false, flag: "ly" },
    { id: "GOLD_SCRAP_18", name: "ذهب كسر 18", regex: "(?:ذهب كسر\\s*18|كسر\\s*18|عيار\\s*18\\s*كسر|18\\s*كسر|كسر الذهب عيار\\s*18|كسر ذهب عيار\\s*18)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 5000, isInverse: false, flag: "ly" },
    { id: "GOLD_SCRAP_21", name: "ذهب كسر 21", regex: "(?:ذهب كسر\\s*21|كسر\\s*21|عيار\\s*21\\s*كسر|21\\s*كسر|كسر الذهب عيار\\s*21|كسر ذهب عيار\\s*21)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 5000, isInverse: false, flag: "ly" },
    { id: "GOLD_CAST_18", name: "ذهب مسبوك 18", regex: "(?:ذهب مسبوك\\s*18|مسبوك\\s*18|عيار\\s*18\\s*مسبوك|18\\s*مسبوك)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 5000, isInverse: false, flag: "ly" },
    { id: "GOLD_CAST_21", name: "ذهب مسبوك 21", regex: "(?:ذهب مسبوك\\s*21|مسبوك\\s*21|عيار\\s*21\\s*مسبوك|21\\s*مسبوك)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 5000, isInverse: false, flag: "ly" },
    { id: "GOLD_CAST_24", name: "ذهب مسبوك 24", regex: "(?:ذهب مسبوك\\s*24|مسبوك\\s*24|عيار\\s*24\\s*مسبوك|24\\s*مسبوك)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 5000, isInverse: false, flag: "ly" },
    { id: "GOLD_LIRA_8G", name: "ليرة ذهب 8 جرام", regex: "(?:ليرة ذهب\\s*8(?:\\s*جرام|ج)?|ليرة ذهب|ليرة\\s*8(?:\\s*جرام|ج)?)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 20000, isInverse: false, flag: "ly" },
    { id: "GOLD_MUJARA_14G", name: "مجارة ذهب 14 جرام", regex: "(?:مجارة ذهب\\s*14(?:\\s*جرام|ج)?|مجارة\\s*14(?:\\s*جرام|ج)?|ليرة ذهب\\s*14(?:\\s*جرام|ج)?|ليرة\\s*14(?:\\s*جرام|ج)?)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 35000, isInverse: false, flag: "ly" },
    { id: "GOLD", name: "كسر الذهب", regex: "(?:كسر الذهب|ذهبي|(?<!ليرة\\s*)(?<!مجارة\\s*)(?<!مسبوك\\s*)ذهب(?!\\s*كسر)(?!\\s*مسبوك)(?!\\s*خارجي)|💎)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 5000, isInverse: false, flag: "ly" },
    { id: "SILVER_CAST_1000", name: "مسبوك فضة عيار 1000", regex: "(?:مسبوك فضة عيار 1000|مسبوك فضة 1000|فضة 1000|مسبوك فضة)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 500, isInverse: false, flag: "ly" },
    { id: "SILVER_SCRAP", name: "كسر فضة", regex: "(?:كسر فضة|كسر الفضة|فضة كسر)[^\\d]{0,40}(\\d{1,5}(?:[\\.,]\\d+)?)(?:\\s+(?:بيع|شراء)?[^\\d]{0,15}(\\d{1,5}(?:[\\.,]\\d+)?))?", min: 1, max: 500, isInverse: false, flag: "ly" },
