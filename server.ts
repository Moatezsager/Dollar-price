...
3. **قواعد استخراج أسعار الذهب والفضة (هام جداً)**:
   ...
   - "ليرة ذهب 8 جرام" أو "ليرة 8" -> استخدم الرمز GOLD_LIRA.
   - "ليرة ذهب 14 جرام" أو "ليرة 14" -> استخدم الرمز GOLD_LIRA_14.
   - "مجارة ذهب 14" أو "مجارة 14" -> استخدم الرمز GOLD_MJARA_14.
