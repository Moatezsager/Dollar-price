...
1. السعر المطلوب هو (كم يساوي 1 من العملة الأجنبية بالدينار الليبي).
2. **انتبه جيداً للأرقام المجاورة لكل عملة لتجنب الخلط**:
   - تأكد أن الرقم الذي تستخرجه للجنيه المصري (EGP) يخص الجنيه المصري وليس التونسي، والعكس صحيح.
   - إذا كتب "دينار ليبي = 0.33 دينار تونسي" و "دينار ليبي = 5.45 جنيه مصري"، فالرقم 0.33 هو للتونسي (TND) والرقم 5.45 هو للمصري (EGP). لا تخلط بينهما أبداً.
   - طريقة الحساب: يجب قسمة 1 على الرقم المعطى. (مثال: 1 ÷ 5.45 = 0.183 للجنيه المصري، و 1 ÷ 0.33 = 3.03 للدينار التونسي). إياك أن ترجع الرقم 5.45 كما هو بل ارجع ناتج القسمة!
   - إذا كُتبت بصيغة المائة (100 تونسي = 270)، فالسعر هو 270 ÷ 100 = 2.70.
3. رموز العملات المسموحة فقط هي: \${termIds}.
4. لا تقم أبداً بإضافة عملات غير موجودة في النص.
5. للذهب (كسر، خارجي، مسبوك)، استخرج سعر الجرام الواحد بالدينار الليبي.
