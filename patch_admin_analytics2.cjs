...
const regex = /{activeTab === 'tracking' && \([\s\S]*?(?=\s*{\/\* Grid of Visitors \*\/)/;
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-black/40 border border-white/10 rounded-3xl p-6">
                     ...
                     <div className="space-y-4">
                       {Object.entries(analyticsData.deviceTypes).sort((a, b) => b[1] - a[1]).map(([device, count]) => (
                         <div key={device}>
                  ...
                  <div className="bg-black/40 border border-white/10 rounded-3xl p-6">
                     ...
                     <div className="space-y-4">
                       {Object.entries(analyticsData.browsers).sort((a, b) => b[1] - a[1]).slice(0, 5).map(([browser, count]) => (
                         <div key={browser}>
                           <div className="flex justify-between text-sm mb-2">
                  ...
                  <div className="bg-black/40 border border-white/10 rounded-3xl p-6">
                     ...
                     <div className="space-y-4">
                       {Object.entries(analyticsData.os).sort((a, b) => b[1] - a[1]).slice(0, 5).map(([os, count]) => (
                         <div key={os}>
                           <div className="flex justify-between text-sm mb-2">
...
if (regex.test(code)) {
    code = code.replace(regex, newTrackingTabStr);
    fs.writeFileSync('src/Admin.tsx', code, 'utf8');
    console.log("Patched Admin.tsx tracking tab with regex.");
} else {
    console.log("Could not patch Admin.tsx tracking tab with regex.");
}
